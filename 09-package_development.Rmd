...
single demo source file inside the `R` folder. You can get rid of this file.
...
want to use the `%>%` operator inside the function you will be writing. To do this without issues,
...
purposes. These scripts, wile not central to the package, could still be of interest to the users.
...
This again creates the right file at the right spot.
