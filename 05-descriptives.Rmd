...
All these tidyverse functions are also called *verbs*. Before learning about these verbs though,
let's discuss about pipes.
...
I think this is the right moment to introduce the `{ViewPipeSteps}` package. This package is still
in development, so you need to install it from Github. But it is a very useful package, because
it allows you to see each step of your tidyverse workflow very easily:
