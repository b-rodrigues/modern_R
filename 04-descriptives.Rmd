...
such as "as", "and"...) and words that are composed of less than 3 characters, and also only keep
words (so we'll remove words that contain special characters or numbers). You can find a dataset
